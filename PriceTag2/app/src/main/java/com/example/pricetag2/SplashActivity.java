...
public class SplashActivity extends Activity {
    ...
    private String xMapCoord, yMapCoord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xMapCoord =  intent.getStringExtra("xMapCoord");
        yMapCoord =  intent.getStringExtra("yMapCoord");

        button3 = findViewById(R.id.button3);
        InitClickListener();

//        intent = new Intent(SplashActivity.this, MapsFragment.class);
//        intent.putExtra("latitude",latitude);
//        intent.putExtra("longitude",longitude);
//        intent.putExtra("xMapCoord",xMapCoord);
//        intent.putExtra("yMapCoord",yMapCoord);
//
    ...
    private void InitClickListener() {
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SplashActivity.this, MapsFragment.class);
                intent.putExtra("latitude",latitude);
                intent.putExtra("longitude",longitude);
                intent.putExtra("xMapCoord",xMapCoord);
                intent.putExtra("yMapCoord",yMapCoord);
